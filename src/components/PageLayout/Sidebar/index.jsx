...
const {
  stackoverflow, github, instagram, twitter,
} = Config.social;
  ...
  <aside>
    ...
    <div className={`${style.name} centerAlign`}>
      ...
      <div className="centerAlign box">
        {/* <a href={stackoverflow} target="_blank" label="button" rel="noopener noreferrer"><FA name="stackoverflow" /></a> */}
...
&nbsp; &nbsp; Iran
      ...
      <div className={style.resumeDownload}>
        <a href="../omid_tavakoli_english_resume_202107278.pdf" download target="_blank">Download CV</a>
      </div>
    </div>
  </aside>
);
